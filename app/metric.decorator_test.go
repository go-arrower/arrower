...
func TestRequestMeteringDecorator_H(t *testing.T) {
	...
	t.Run("successful request", func(t *testing.T) {
		...
		handler := app.NewMeteredRequest[request, response](meterProvider, &requestSuccessHandler{})
	...
	t.Run("failed request", func(t *testing.T) {
		...
		handler := app.NewMeteredRequest[request, response](meterProvider, &requestFailureHandler{})
...
func TestCommandMeteringDecorator_H(t *testing.T) {
	...
	t.Run("successful command", func(t *testing.T) {
		...
		handler := app.NewMeteredCommand[request](meterProvider, &commandSuccessHandler{})
	...
	t.Run("failed command", func(t *testing.T) {
		...
		handler := app.NewMeteredCommand[request](meterProvider, &commandFailureHandler{})
...
func TestQueryMeteringDecorator_H(t *testing.T) {
	...
	t.Run("successful query", func(t *testing.T) {
		...
		handler := app.NewMeteredQuery[request, response](meterProvider, &requestSuccessHandler{})
	...
	t.Run("failed query", func(t *testing.T) {
		...
		handler := app.NewMeteredQuery[request, response](meterProvider, &requestFailureHandler{})
...
func TestJobMeteringDecorator_H(t *testing.T) {
	...
	t.Run("successful job", func(t *testing.T) {
		...
		handler := app.NewMeteredJob[request](meterProvider, &commandSuccessHandler{})
	...
	t.Run("failed job", func(t *testing.T) {
		...
		handler := app.NewMeteredJob[request](meterProvider, &commandFailureHandler{})
